...
{
	int param;
	int srate = 16000; // default sample rate 22050 Hz
	...
	SetParameter(espeakRATE, 95, 0);
	SetParameter(espeakVOLUME, 50, 0);
	SetParameter(espeakCAPITALS, option_capitals, 1);
	SetParameter(espeakPUNCTUATION, option_punctuation, 1);
...
static const char version_string[] = "Embedded";
